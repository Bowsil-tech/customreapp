namespace customeracpp
{
    public static class AppConstants
    {
        ...
        /// </summary>
        public static string NotificationHubName { get; set; } = "customerapp";
        ...
        /// </summary>
        public static string ListenConnectionString { get; set; } = "Endpoint=sb://agentapp.servicebus.windows.net/;SharedAccessKeyName=DefaultFullSharedAccessSignature;SharedAccessKey=5QjYNGnubcdnCqa7CXIxbDGLDE7jIDZ2EAFNiT8E7Ok=";
        ...
        /// are defined by the device and can include multiple parameters.
        /// </summary>
        public static string APNTemplateBody { get; set; } = "{\"aps\":{\"alert\":\"$(messageParam)\",\"url\":\"$(messageParam)\"}}";
    }
}
